...
def authorize():
    ...
    print(f'Redirect URL: {flow.redirect_uri}')
...
def oauth2callback():
    ...
    # FIXME
    print(f'*** CREDENTIALS: ***{"*" * 20}')
    pprint.pprint(credentials_to_dict(credentials))
    print('**********' * 4)

    # FIXME
    with open('creds-user.json', 'w', encoding='utf-8') as fd:
        json.dump(credentials_to_dict(credentials), fd, indent=2)
...
def print_index_table():
    return ('<table>' + '<tr><td><a href="/test">Test an API request</a></td>' +
